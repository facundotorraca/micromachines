...
public:
    explicit TextureFactory(SDL_Renderer* renderer){
        if (renderer) {
            ...
            textures.emplace(TYPE_BOOST, createTexture(renderer, "assets/sprites/modifiers/rect.png")); //boost
            textures.emplace(TYPE_FIX, createTexture(renderer, "assets/sprites/modifiers/rect.png")); //fix
            textures.emplace(TYPE_MUD, createTexture(renderer, "assets/sprites/modifiers/rect.png")); //mud
            textures.emplace(TYPE_OIL, createTexture(renderer, "assets/sprites/modifiers/rect.png")); //oil
            textures.emplace(TYPE_ROCK, createTexture(renderer, "assets/sprites/modifiers/rect.png")); //rock
